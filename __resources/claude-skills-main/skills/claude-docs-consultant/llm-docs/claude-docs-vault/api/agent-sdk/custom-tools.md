...
description: "Build and integrate custom tools to extend Claude Agent SDK functionality"
tags:
  - api
  - agent-sdk
  - sdk
...
**Source:** [Official Documentation](https://docs.claude.com/en/api/agent-sdk/custom-tools)
