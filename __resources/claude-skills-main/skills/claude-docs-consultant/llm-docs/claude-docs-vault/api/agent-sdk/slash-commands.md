...
* [[slash-commands|Slash Commands]] - Complete slash command documentation
* [[subagents|Subagents in the SDK]] - Similar filesystem-based configuration for subagents
* [TypeScript SDK reference](https://docs.claude.com/en/docs/claude-code/typescript-sdk-reference) - Complete API documentation
* [[overview|SDK overview]] - General SDK concepts
* [[cli-reference|CLI reference]] - Command-line interface

---

**Source:** [Official Documentation](https://docs.claude.com/en/api/agent-sdk/slash-commands)
