...
>
>   * [[list-skills|Skill Management API Reference]] - CRUD operations for Skills
>   * [[list-skill-versions|Skill Versions API Reference]] - Version management

## Quick Links


> [!info] Get started with Agent Skills
> Create your first Skill

  > [!info] Create Custom Skills
...
| **Management**     | Pre-built and maintained by Anthropic      | Upload and manage via [[create-skill|Skills API]] |
| **Availability**   | Available to all users                     | Private to your workspace                                       |

Both skill sources are returned by the [[list-skills|List Skills endpoint]] (use the `source` parameter to filter). The integration shape and execution environment are identical—the only difference is where the Skills come from and how they're managed.
...
> [!note]
> For complete details on the Files API, see the [[files-content|Files API documentation]].
...
For complete request/response schemas, see the [[create-skill|Create Skill API reference]].
...
See the [[list-skills|List Skills API reference]] for pagination and filtering options.
...
See the [[create-skill-version|Create Skill Version API reference]] for complete details.
...
See the [[code-execution-tool|code execution tool documentation]] for available packages.
...
**Source:** [Official Documentation](https://docs.claude.com/en/api/skills-guide)
