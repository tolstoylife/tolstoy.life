...
description: "The [Claude for Sheets extension](https://workspace.google.com/marketplace/app/claude%5Ffor%5Fsheets/909417792257) integrates Claude into Google Sheets, allowing you to execute interactions with Claude directly in cells."
tags:
  - docs
  - agents-and-tools
  - agent
...
**Step 2: Install the Claude for Sheets extension**
...
> `model` is always second in the list.
    ...
    Any [[messages|API parameter]] can be set this way. You can even pass in an API key to be used just for this specific cell, like this:  `"api_key", "sk-ant-api03-j1W..."`



## Advanced use

`CLAUDEMESSAGES` is a function that allows you to specifically use the [[messages|Messages API]]. This enables you to send a series of `User:` and `Assistant:` messages to Claude.

This is particularly useful if you want to simulate a conversation or [[prefill-claudes-response|prefill Claude's response]].
...
> [!info]- Example multiturn CLAUDEMESSAGES() call with system prompt
...
> [!info]- Example: Setting parameters
...
> [!info]- NAME? Error: Unknown function: 'claude'
...
> [!info]- #ERROR!, ⚠ DEFERRED ⚠ or ⚠ THROTTLED ⚠
...
**Source:** [Official Documentation](https://docs.claude.com/en/docs/agents-and-tools/claude-for-sheets)
