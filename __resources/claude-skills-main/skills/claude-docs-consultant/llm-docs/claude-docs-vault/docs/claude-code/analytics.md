...
description: "View detailed usage insights and productivity metrics for your organization's Claude Code deployment."
tags:
  - docs
  - claude-code
related:
...
* [[monitoring-usage|Monitoring usage with OpenTelemetry]] for custom metrics and alerting
* [Identity and access management](https://docs.claude.com/en/docs/claude-code/iam) for role configuration

---

**Source:** [Official Documentation](https://docs.claude.com/en/docs/claude-code/analytics)
