...
> [!warning]
> WSL users may need additional configuration for IDE detection to work properly. See our [[troubleshooting#jetbrains-ide-not-detected-on-wsl2|WSL troubleshooting guide]] for detailed setup instructions.
...
* For WSL users, see the [[troubleshooting#jetbrains-ide-not-detected-on-wsl2|WSL troubleshooting guide]]
...
**Source:** [Official Documentation](https://docs.claude.com/en/docs/claude-code/jetbrains)
