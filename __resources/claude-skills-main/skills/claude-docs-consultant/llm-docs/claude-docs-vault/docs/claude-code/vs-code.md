...
description: "Use Claude Code with Visual Studio Code through our native extension or CLI integration"
tags:
  - docs
  - claude-code
related:
...
* **Full MCP server configuration**: You need to [[mcp|configure MCP servers through the CLI]] first, then the extension will use them
* **Subagents configuration**: Configure [[sub-agents|subagents through the CLI]] to use them in VS Code
...
For additional help, see our [[troubleshooting|troubleshooting guide]].

---

**Source:** [Official Documentation](https://docs.claude.com/en/docs/claude-code/vs-code)
