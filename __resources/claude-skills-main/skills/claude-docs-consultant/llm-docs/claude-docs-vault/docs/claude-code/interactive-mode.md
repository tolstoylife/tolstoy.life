...
| `Tab`                                        | Toggle [[extended-thinking|extended thinking]] | Switch between Thinking on and Thinking off                 |
...
| `/` at start | Slash command                      | See [[slash-commands|slash commands]]     |
...
* [[slash-commands|Slash commands]] - Interactive session commands
* [[checkpointing|Checkpointing]] - Rewind Claude's edits and restore previous states
* [[cli-reference|CLI reference]] - Command-line flags and options
* [[settings|Settings]] - Configuration options
* [[memory|Memory management]] - Managing CLAUDE.md files

---

**Source:** [Official Documentation](https://docs.claude.com/en/docs/claude-code/interactive-mode)
