...
Plugin entries can override default component locations and provide additional metadata. Note that `${CLAUDE_PLUGIN_ROOT}` is an environment variable that resolves to the plugin's installation directory (for details see [[plugins-reference#environment-variables|Environment variables]]):
...
For complete plugin testing workflows, see [[plugins#test-your-plugins-locally|Test your plugins locally]]. For technical troubleshooting, see [[plugins-reference|Plugins reference]].
...
* [[plugins|Plugins]] - Installing and using plugins
* [[plugins-reference|Plugins reference]] - Complete technical specifications and schemas
* [[plugins#develop-more-complex-plugins|Plugin development]] - Creating your own plugins
* [[settings#plugin-configuration|Settings]] - Plugin configuration options

---

**Source:** [Official Documentation](https://docs.claude.com/en/docs/claude-code/plugin-marketplaces)
