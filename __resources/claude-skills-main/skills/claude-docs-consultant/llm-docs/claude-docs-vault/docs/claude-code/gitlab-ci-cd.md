...
url: https://docs.claude.com/en/docs/claude-code/gitlab-ci-c
category: docs
...
> [!note]
> This integration is built on top of the [Claude Code CLI and SDK](https://docs.claude.com/en/docs/claude-code/sdk), enabling programmatic use of Claude in your CI/CD jobs and custom automation workflows.
...
* **API costs**:
  ...
  * See [[pricing|Anthropic pricing]] for details
...
**Source:** [Official Documentation](https://docs.claude.com/en/docs/claude-code/gitlab-ci-c)
