...
> [!note]
> MTok = Million tokens. The "Base Input Tokens" column shows standard input pricing, "Cache Writes" and "Cache Hits" are specific to [[prompt-caching|prompt caching]], and "Output Tokens" shows output pricing. Prompt caching offers both 5-minute (default) and 1-hour cache durations to optimize costs for different use cases.
>
...
Claude models are available on [[claude-on-amazon-bedrock|AWS Bedrock]] and [[claude-on-vertex-ai|Google Vertex AI]]. For official pricing, visit:
...
>
>   * [[claude-on-amazon-bedrock#global-vs-regional-endpoints|AWS Bedrock global vs regional endpoints]]
>   * [[claude-on-vertex-ai#global-vs-regional-endpoints|Google Vertex AI global vs regional endpoints]]
...
| Claude Sonnet 3.7 ([[model-deprecations|deprecated]]) | \$1.50 / MTok  | \$7.50 / MTok  |
| Claude Haiku 4.5                                                           | \$0.50 / MTok  | \$2.50 / MTok  |
| Claude Haiku 3.5                                                           | \$0.40 / MTok  | \$2 / MTok     |
| Claude Opus 3 ([[model-deprecations|deprecated]])     | \$7.50 / MTok  | \$37.50 / MTok |
| Claude Haiku 3                                                             | \$0.125 / MTok | \$0.625 / MTok |

For more information about batch processing, see our [[batch-processing|batch processing documentation]].

### Long context pricing

When using Claude Sonnet 4 or Sonnet 4.5 with the [[context-windows#1m-token-context-window|1M token context window enabled]], requests that exceed 200K input tokens are automatically charged at premium long context rates:

> [!note]
> The 1M token context window is currently in beta for organizations in [[rate-limits|usage tier]] 4 and organizations with custom rate limits. The 1M token context window is only available for Claude Sonnet 4 and Sonnet 4.5.
...
For more information about the `usage` object, see the [[messages#response-usage|API response documentation]].
...
| Claude Sonnet 3.7 ([[model-deprecations|deprecated]]) | `auto`, `none`<hr className="my-2" />`any`, `tool` | 346 tokens<hr className="my-2" />313 tokens |
...
| Claude Opus 3 ([[model-deprecations|deprecated]])     | `auto`, `none`<hr className="my-2" />`any`, `tool` | 530 tokens<hr className="my-2" />281 tokens |
...
For more information about tool use implementation and best practices, see our [[overview|tool use documentation]].
...
| `text_editor_20250124` (Claude Sonnet 3.7 ([[model-deprecations|deprecated]])) | 700 tokens              |
...
Computer use follows the standard [[overview#pricing|tool use pricing]]. When using the computer use tool:
...
| Claude Sonnet 3.7 ([[model-deprecations|deprecated]]) | 735 tokens                       |

**Additional token consumption**:

* Screenshot images (see [[vision|Vision pricing]])
...
For a detailed walkthrough of this calculation, see our [[customer-support-chat|customer support agent guide]].
...
For a comprehensive guide on agent pricing patterns, see our [agent use cases guide](https://docs.claude.com/en/docs/about-claude/use-case-guides).
...
For detailed rate limit information, see our [[rate-limits|rate limits documentation]].
...
**Source:** [Official Documentation](https://docs.claude.com/en/docs/about-claude/pricing)
