...
> [!info]- Task fidelity (sentiment analysis) - exact match evaluation
...
>     ```
  ...
  > [!info]- Consistency (FAQ bot) - cosine similarity evaluation
...
>     ```
  ...
  > [!info]- Relevance and coherence (summarization) - ROUGE-L evaluation
...
>     ```
  ...
  > [!info]- Tone and style (customer service) - LLM-based Likert scale
...
>     ```
  ...
  > [!info]- Privacy preservation (medical chatbot) - LLM-based binary classification
...
>     ```
  ...
  > [!info]- Context utilization (conversation assistant) - LLM-based ordinal scale
...
> [!info]- Example: LLM-based grading
> ```python  theme={null}
>   import anthropic
>
...
**Source:** [Official Documentation](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests)
