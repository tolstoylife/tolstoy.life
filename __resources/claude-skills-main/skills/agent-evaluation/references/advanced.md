...
This reference provides advanced LLM-as-Judge techniques, bias mitigation strategies, implementation patterns, metrics guidance, and practical examples.
...
This section provides practical prompt patterns and workflows for evaluating Claude Code commands, skills, and agents during development.
...
1. **Mark as invalid and ignore for analysis** - incorrect output, usually means hallucinations during thinking process

2. **Retry initial prompt without changes** - multiple retries usually more consistent rather one shot prompt
...
**Weighted Kappa**: For ordinal scales where disagreement severity matters
